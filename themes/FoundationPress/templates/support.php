...
<div class="row page-title">
  <h1 class="strike"><span>Support</span></h1>
</div>
    ...
    <div class="row explanatory-block">
      ...
      <div class="column large-4 medium-4 text-center">
        ...
        <div class="explanatory-text">
          ...
          <p><?php echo qtranxf_getLanguage() === "zh" ? "透過你的捐助，PAHK將最好的公共藝術帶到世界不同各地。" : "Your generous donation make it possible for PAHK to continue presenting the very best public art to the world." ; ?></p>
        </div>
      </div>
      <div class="column large-4 medium-4 text-center">
        <img class="block-icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/icon-sculpture.png">
